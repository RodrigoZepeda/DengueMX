...
parameters {
  ...
  matrix[arma_p, N_states]  beta_dengue_AR_state_std;
}
...
transformed parameters {
  ...
  matrix[arma_p, N_states]  beta_dengue_AR_state;
  ...
  beta_dengue_week_state   = rep_matrix(beta_dengue_week, N_states)   + rep_matrix(sigma_dengue_week_state, N_weeks_dengue).*beta_dengue_week_state_std;
...
model {
  ...
  //Standarized parameters
  {
    ...
    to_vector(beta_dengue_AR_state_std)     ~ std_normal();
