...
# Directorio 2017
dir_2021 = "panoramas_epidemiologicos_previos/2021"
...
# Directorio de 2017
fnames = [os.path.join(dir_2021, f) for f in listdir(dir_2021)]
...
# Save as csv
df_all.to_csv(os.path.join("panoramas_epidemiologicos_previos/processed", "2021.csv"), index=False)
