...
# Directorio 2017
dir_2022 = "panoramas_epidemiologicos_previos/2022"
...
# Directorio de 2017
fnames = [os.path.join(dir_2022, f) for f in listdir(dir_2022)]
...
# Save as csv
df_all.to_csv(os.path.join("panoramas_epidemiologicos_previos/processed", "2022.csv"), index=False)
