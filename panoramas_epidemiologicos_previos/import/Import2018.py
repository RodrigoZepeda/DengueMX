...
# Directorio 2017
dir_2018 = "panoramas_epidemiologicos_previos/2018"
...
estados = {"CHIAPAS", "VERACRUZ", "NUEVO LEÓN", "GUERRERO", "MICHOACÁN", "TAMAULIPAS",
           ...
           "CIUDAD DE MÉXICO","CD MÉXICO","AGUASCALIENTES"}

# Directorio de 2017
fnames = [os.path.join(dir_2018, f) for f in listdir(dir_2018)]
...
# Save as csv
df_all.to_csv(os.path.join("panoramas_epidemiologicos_previos/processed", "2018.csv"),  index=False)
